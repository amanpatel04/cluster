...
const Sidebar = () => {
    ...
    return (
        <>
            <div
                className={`h-full w-48 fixed bg-green-50 z-10 ease-linear duration-300 shadow-lg top-0 pt-10`}
                style={{ left: isOpen ? '0%' : '-12rem' }}
            >
                <div
                    className="bg-green-50 w-10 h-10 flex justify-center items-center absolute left-full hover:cursor-pointer top-1/3 bg-[rgb(0,255,0,0.1)]"
